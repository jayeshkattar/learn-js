...
let obj31 = {
  ...
  myFunc: function () {
    ...
    setTimeout(() => {
      console.log(this.myVar);   // async ARROW fn running in its own scope has this bound to closest non-arrow fn.
    }, 1000);
  },
};
obj31.myFunc();
...
myFunc1.showArgs(1, 2, 3, 4); // Reference error: arguments is not defined
